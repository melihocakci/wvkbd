...
static struct key keys_full[], keys_special[], keys_cyrillic[], keys_german[],
  keys_compose_a[],
...
static struct layout layouts[NumLayouts] = {
  ...
  [German] = {keys_german, "latin", "german", true},
...
static struct key keys_german[] = {
  ...
  {"9", ")", 1.0, Code, KEY_9, &layouts[ComposeBracket]},
  {"0", "=", 1.0, Code, KEY_0, &layouts[ComposeBracket]},
  {"ß", "ẞ", 1.0, Code, KEY_MINUS, &layouts[ComposeBracket]},
  {"´", "`", 1.0, Code, KEY_EQUAL, &layouts[ComposeBracket]},
  {"⌫", "⌫", 1.5, Code, KEY_BACKSPACE, .scheme = 1},
  {"", "", 0.0, EndRow},
...
static struct key keys_index[] = {
  ...
  {"De", "De", 1.0, Layout, 0, &layouts[German], .scheme = 1},
  {"", "", 0.0, Last},
};
